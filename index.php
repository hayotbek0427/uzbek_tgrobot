...
$soat1 = date('H:i:s',strtotime('0 hour')); 
$sana1 = date('d-M Y',strtotime('0 hour'));
$sana2 = date('z',strtotime('0 hour'));
$gmt = date('O',strtotime('0 hour'));
$oynomi = date('F',strtotime('0 hour'));
$buoy = date('t',strtotime('0 hour'));
